...
export function AppHeader({ left, right }: Props) {
  return (
    <header className="sticky top-0 z-10 px-8 lg:px-16 py-3 border-b border-border bg-bg-elev w-full flex-shrink-0 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
