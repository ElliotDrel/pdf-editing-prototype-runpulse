		...
		>
			...
			<div
				className={`flex items-center gap-1.5 border-b pb-1 transition-all duration-250 ${
					active ? "border-accent text-accent" : "border-paper-line"
				}`}
			>
				{field.type === "checkbox" && (
					<span className="text-paper-ink text-[10px] select-none flex-shrink-0">
						...
						field.value.toLowerCase() !== "unchecked"
							? "☒"
							: "☐"}
					</span>
				)}
		...
		>
			<div className="px-6 pt-5 pb-6">
				<div className="text-center mb-4">
					...
					<div className="font-mono text-[7.5px] text-paper-ink/45">
						{subtitle}
					</div>
				</div>
